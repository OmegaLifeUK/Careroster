...
export default function DayCentreStaff() {
  ...
  const staff = allStaff.filter(s => s.care_setting === 'day_centre');
    ...
    <div className="p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Day Centre Staff</h1>
            <p className="text-gray-500">Manage your day centre team</p>
          </div>
          <div className="flex gap-2">
            <ExportButton 
              data={exportData} 
              filename="daycentre-staff" 
              ...
              <CardContent className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-amber-400 to-amber-500 flex items-center justify-center text-white font-semibold text-lg">
                ...
                {member.hourly_rate && (
                  <div className="mb-4 p-2 bg-amber-50 rounded">
                    <p className="text-xs text-amber-700">Hourly rate:</p>
                    <p className="text-sm font-medium text-amber-900">£{member.hourly_rate}</p>
                  </div>
                )}
