...
export default function SplitScreenScheduler({ 
  ...
  const getShiftsForCarerAndDate = (carerId, date) => {
    ...
    return shifts.filter(s => s.carer_id === carerId && s.date === dateStr);
  };
  ...
  return (
    <div className="flex h-[calc(100vh-200px)] bg-white border rounded-lg overflow-hidden shadow-lg">
